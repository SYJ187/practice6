...
<script>
  ...
  import stroage from 'assets/js/storage';
  import { CATEGORY_CONTENT_UPDATE_TIME_INTERVAL, CATEGORY_CONTENT_KEY } from './config';
  ...
  export default {
    ...
    methods: {
      ...
      getContent(id) {
        let contents = stroage.get(CATEGORY_CONTENT_KEY);
        let updateTime;
      ...
      updateLocalStorage(contents, id, curTime) {
        ...
        stroage.set(CATEGORY_CONTENT_KEY, contents);
      },
      updateScroll() {
